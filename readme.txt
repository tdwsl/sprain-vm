...
80   or ax,I32       or bx,I32       or cx,I32       or dx,I32
       or al,I8        or bl,I8        or cl,I8        or dl,I8
         or ax,I32       or bx,I32       or cx,I32       or dx,I32
           or al,I8        or bl,I8        or cl,I8        or dl,I8
90   xor ax,I32      xor bx,I32      xor cx,I32      xor dx,I32
       xor al,I8       xor bl,I8       xor cl,I8       xor dl,I8
         xor ax,I32      xor bx,I32      xor cx,I32      xor dx,I32
           xor al,I8       xor bl,I8       xor cl,I8       xor dl,I8
A0   shr ax,I8       shr bx,I8       shr cx,I8       shr dx,I8
       shl ax,I8       shl bx,I8       shl cx,I8       shl dx,I8
         ror ax,I8       ror bx,I8       ror cx,I8       ror dx,I8
           rol ax,I8       rol bx,I8       rol cx,I8       rol dx,I8
B0   add ax,I32      add bx,I32      add cx,I32      add dx,I32
       add al,I8       add bl,I8       add cl,I8       add dl,I8
         add ax,I32      add bx,I32      add cx,I32      add dx,I32
           add al,I8       add bl,I8       add cl,I8       add dl,I8
C0   push ax         push bx         push cx         push dx
       pop ax          pop bx          pop cx          pop dx
        jmp ax          jmp bx           jmp cx          jmp dx
          call ax         call bx          call cx         call dx
D0   jm R8           jv R8           jc R8           jz R8
       jnm R8          jnv R8          jnc R8          jnz R8
         --              --              --              --
           --              --              --              --
E0   --              --              --              --
       --              --              --              --
